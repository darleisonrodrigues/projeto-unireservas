...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Dados sendo enviados:', { ...registerData, password: '***' });
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      toast({
        title: "Erro no cadastro",
        description: error instanceof Error ? error.message : "Erro ao criar conta com Google",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
  ...
  const handleAppleRegister = async () => {
    ...
    try {
      ...
      toast({
        title: "Erro no cadastro",
        description: error instanceof Error ? error.message : "Erro ao criar conta com Apple",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
