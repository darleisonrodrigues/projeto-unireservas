...
const RegisterFirebasePage = () => {
  ...
  const { register } = useAuthFirebase();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Dados sendo enviados para Firebase:', { ...registerData, password: '***' });

      await register(registerData);

      toast({
        title: "Conta criada com sucesso!",
        description: "Bem-vindo ao Uni Reservas!",
        variant: "default"
      });
      ...
      if (error instanceof Error) {
        ...
        if (error.message.includes('email-already-in-use')) {
          ...
          errorDescription = "Este email já está sendo usado. Tente fazer login.";
        } else if (error.message.includes('weak-password')) {
          errorTitle = "Senha muito fraca";
          errorDescription = "Escolha uma senha mais forte.";
        } else if (error.message.includes('invalid-email')) {
          errorTitle = "Email inválido";
          errorDescription = "Verifique se o email está correto.";
        }
      }
